...
import { getGeometry as getCrateGeo, getMaterials as getCrateMats } from "@/lib/AmmoCrate";
...
export async function mountCreditsFinalePreview(canvas) {
  ...
  const crate = new THREE.Mesh(getCrateGeo(), getCrateMats());
  prepareMesh(crate);
