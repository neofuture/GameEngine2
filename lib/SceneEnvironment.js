...
export function createOutdoorLights(scene, options = {}) {
  ...
  // Color + intensity are overwritten by applyHemisphereSettings (HemisphereTuning).
  ...
  if (sheltered) {
    ...
    overhead.userData.dayNightRole = "ceilingFill";
    ...
    deckBounce.userData.dayNightRole = "ceilingFill";
    ...
    const outdoorLights = [hemi, ambient, sun, moon, overhead, deckBounce, fill, westFill];
    for (const light of outdoorLights) {
