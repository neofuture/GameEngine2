...
// Baked-in defaults (used when no arena/localStorage values exist).
export const STAIR_X_DEFAULT = 0.112;
export const STAIR_Y_DEFAULT = -0.038;
export const STAIR_Z_DEFAULT = -8.434;
